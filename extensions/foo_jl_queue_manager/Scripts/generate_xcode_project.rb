#!/usr/bin/env ruby
# Generate Xcode project for foo_jl_queue_manager
...
PROJECT_NAME = "foo_jl_queue_manager"
BUNDLE_ID = "com.foobar2000.foo-jl-queue-manager"
SDK_PATH = Fb2kSdk.path

# Version from shared/version.h (single source of truth)
COMPONENT_VERSION = Fb2kVersions.get("queue_manager")
BUILD_NUMBER = Fb2kVersions.get_build_number("queue_manager")
