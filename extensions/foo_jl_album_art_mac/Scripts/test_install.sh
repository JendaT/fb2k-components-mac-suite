...
echo ""
echo "Usage in layout editor:"
echo "  albumart_ext              - Front cover (default)"
echo "  albumart_ext type=back    - Back cover"
echo "  albumart_ext type=disc    - Disc art"
echo "  albumart_ext type=icon    - Album icon"
echo "  albumart_ext type=artist  - Artist picture"
echo ""
echo "Right-click to change artwork type."
echo "Hover to see navigation arrows."
echo ""
