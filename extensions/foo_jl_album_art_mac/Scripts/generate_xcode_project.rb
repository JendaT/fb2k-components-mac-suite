#!/usr/bin/env ruby
# Generate Xcode project for foo_jl_album_art_mac
...
BUNDLE_ID = "com.foobar2000.foo-jl-album-art"
SDK_PATH = Fb2kSdk.path

# Version from shared/version.h (single source of truth)
COMPONENT_VERSION = Fb2kVersions.get("albumart")
BUILD_NUMBER = Fb2kVersions.get_build_number("albumart")
