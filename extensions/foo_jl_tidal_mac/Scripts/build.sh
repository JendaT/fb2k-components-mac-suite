#!/bin/bash
#
# build.sh - Build foo_jl_tidal component
#
# Usage:
...
# Unit tests gate the build: pure-logic Core modules must pass before
# compiling the component. Fast (~1s) — Foundation-only, no SDK, no Xcode.
