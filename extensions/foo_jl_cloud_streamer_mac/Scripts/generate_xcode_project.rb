#!/usr/bin/env ruby
# Generate Xcode project for foo_jl_cloud_streamer_mac
...
BUNDLE_ID = "com.foobar2000.foo-jl-cloud-streamer"
SDK_PATH = Fb2kSdk.path

# Version from shared/version.h (single source of truth)
COMPONENT_VERSION = Fb2kVersions.get("cloud_streamer")
BUILD_NUMBER = Fb2kVersions.get_build_number("cloud_streamer")
