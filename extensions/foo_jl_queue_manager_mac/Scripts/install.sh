#!/bin/bash
#
# install.sh - Install foo_jl_queue_manager to foobar2000
#
# Usage:
...
if [ ! -d "$COMPONENT_PATH" ]; then
    ...
    print_error "Build the project first with: xcodebuild -project $PROJECT_NAME.xcodeproj -configuration $BUILD_CONFIG"
    exit 1
fi
