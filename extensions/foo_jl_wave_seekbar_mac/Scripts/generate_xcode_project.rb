#!/usr/bin/env ruby
# Generate Xcode project for foo_wave_seekbar_mac
...
BUNDLE_ID = "com.foobar2000.foo-jl-wave-seekbar"
SDK_PATH = Fb2kSdk.path

# Version from shared/version.h (single source of truth)
COMPONENT_VERSION = Fb2kVersions.get("waveform")
BUILD_NUMBER = Fb2kVersions.get_build_number("waveform")
